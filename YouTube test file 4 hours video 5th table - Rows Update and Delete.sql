...
/*Update / Replace student table specifically all contents of major column to undecided.*/
 UPDATE student
 SET major = 'undecided';

 
 
/*Delete any rows in table specifically where name = Tom and major = undecided.*/
 DELETE FROM student 
 WHERE name = 'Tom' AND major = 'undecided';
 SELECT * FROM student;
 
 
 /*Delete any rows in table with a student ID of 5.*/
 DELETE FROM student 
 WHERE student_id= 5;
 SELECT * FROM student;
